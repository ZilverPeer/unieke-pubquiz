...
Pick zero to eight Categories, then click **Toevoegen aan winkelwagen** -- this takes you straight to checkout (spec 6, #147), not the product or cart page. Trying to add the exact same Taal/Moeilijkheid/Categorieën combination a second time is refused with WooCommerce's own message ("Je hebt ... al in je winkelwagen ..."), staying on the product page; a *different* combination redirects to checkout and becomes a second cart line there -- see "A second Quiz in the same order" below.
