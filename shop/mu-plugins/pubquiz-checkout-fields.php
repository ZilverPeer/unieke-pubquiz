 ...
 * Description: For a cart made up entirely of virtual products (the
 *              Pubquiz product is virtual, spec #55 "Guest checkout,
 *              minimal fields"), removes every billing field except first
 *              name, last name and email -- WooCommerce already skips the
 *              shipping fields for a virtual-only cart by itself, this
 *              plugin does the same for billing.
 *
