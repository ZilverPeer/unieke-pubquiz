...
// Recorded real WooCommerce payload (ticket #37, re-recorded for #71
// without pubquiz_mode) -- one line item, quantity 1, three Category picks
// in pick order (ids "1", "3", "5") plus locale/difficulty meta -- see
// shop/README.md "The webhook".
